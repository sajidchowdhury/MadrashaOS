...
const PERMISSION_CODES = [
  ...
  // Operations
  "inventory.view", "inventory.receive", "inventory.issue", "inventory.sale", "purchase.view",
...
const ROLE_PERMS: Record<string, string[]> = {
  ...
  authority: [
    ...
    "fees.payment.create", "scholarship.view", "scholarship.approve", "accounting.ledger.view",
    "accounting.ledger.post", "zakat.view", "donations.view", "inventory.view", "inventory.sale", "purchase.view",
  ...
  administrator: [
    ...
    "fees.plan.edit", "fees.payment.create", "scholarship.view", "accounting.ledger.view",
    "accounting.ledger.post", "inventory.view", "inventory.sale",
